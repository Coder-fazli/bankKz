...
class FinancialCalculatorShortcodes {
    ...
    public function kredit_calculator_shortcode($atts) {
        ...
        ob_start();
        ?>
        <div class="financial-calculator-widget kredit-calculator-widget" id="<?php echo esc_attr($unique_id); ?>">
                ...
                <div class="calculator credit-calculator active">
                    <div class="value-box">
                        ...
                        <div class="value-display">
                            <span id="credit-amount-display-<?php echo esc_attr($unique_id); ?>">25,000</span>₸
                        </div>
